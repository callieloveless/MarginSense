...
- [ ] 1.4 Tighten Photo Advisor's system prompt: anything with a permit, code, or inspection angle
...
- [ ] 2.3 Add `src/tools/code-finder/code-finder.ts`: the system prompt (find LOCAL code, return
